...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1On3109PbpUCIFma1CQ_b9lf32JuM5Qp5?usp=sharing)
...
1.  **Clone the Repository:**
    ```bash
    git clone https://github.com/sanjana-ps12/AI-IN-MOBILITY.git
    cd AI-IN-MOBILITY
    ```
